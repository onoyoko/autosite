...
document.write('<script>var m_select="topid0"; var m_topselect="topid0";//zorgen dat het laaste element geselecteert is ; </script><!--Lieven Roegiers __djdb__-->');//geselecteerde item by id
...
function menu_css(){
	...
	document.write(" .mnu{"+m_texta+ I +"position:absolute;"+ m_cur+" top:"+m_top+"px; "+ m_just+" background:#FFF; filter:alpha(opacity=45); -moz-opacity:.45;	opacity:.45; border-left:"+m_rand2+"border-right:"+m_rand2+"border-top:"+m_rand+"border-bottom: "+m_rand2+ ";  z-index:2}");
		document.write(" .nav{"+m_texta+ I +"position:absolute;width:100%;"+ m_cur+" top:0px; "+ m_just+" background:"+m_Bcolor+";  z-index:2}");
	document.write(" .mnutop{position:absolute;"+m_Margin+m_texta+" " + m_cur + "background:"+m_Bcolor+ m_just +"}border-bottom: "+m_rand +"z-index:2");
