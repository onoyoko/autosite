...
function menu_css(){
	...
	document.write(" .mnu_click{top:10px;"+m_text + m_cur+ m_font + " background:"+ m_Fcolor+ ";}");
	document.write(" #menu div.mnu_click{"+m_toplayout+m_toplayout_click+" }") ;
	document.write(" .mnu_out{"+m_text+m_cur+ m_font+" background: "+ m_Bcolor +" }") ;
	document.write(" #menu div.mnu_out{"+m_toplayout+m_toplayout_out+" }") ;
	document.write(" .hidden{visibility:hidden;}");
	document.write(" .mnu_hover{"+m_text+m_cur+ m_font+" background:"+m_Hcolor +" }");
	document.write(" #menu div.mnu_hover{"+m_toplayout+m_toplayout_hover+" }");
	document.write(" .mnu{"+m_text+ I +"position:absolute;width:80%;"+ m_cur+" top:"+m_top+"px;  background:"+m_Bcolor+"; border-left:"+m_rand2+"border-right:"+m_rand2+"border-top:"+m_rand+"border-bottom: "+m_rand2+ ";  z-index:2}");
	document.write(" .nav{"+m_text+ I +"position:absolute;width:80%;"+ m_cur+"left:20px; top:1000px; "+ m_just+" background:"+m_Bcolor+";  z-index:2}");
	document.write(" .mnutop{"+m_text+" width:80%;" + m_cur + "background:"+m_Bcolor+"border-bottom: "+m_rand +"z-index:3}");
...
function M_item(id,label,pos,nav){//subitem printen
	...
	if (typeof(label[1])!="undefined"){
		V_return+="|<a href='"+m_vieuw+label[1]+"' target='"+m_target+"'";
